...
;; (setf recentf-save-file (expand-emacs-dir ".automake/recentf"))
;; (setf auto-save-list-file-prefix (expand-emacs-dir ".automake/auto-save-list/.saves-"))
;; (setf url-configuration-directory (expand-emacs-dir ".automake/url/"))
;; (setf url-cookie-file (expand-emacs-dir ".automake/url/cookies"))
;; (setf custom-file (expand-emacs-dir ".automake/custom"))
